...
(function (global) {
	...
	function snippet_toolbar_html(executeOnclick, executeBorder) {
		var border = executeBorder ? " border-color: " + executeBorder + ";" : "";
		return (
			'<div class="snippet-toolbar" style="position: absolute; bottom: -68px; right: -5px; display: flex; align-items: center; gap: 8px;">' +
			...
			'<div class="gamebutton snippetbtn" style="padding:4px 12px;' +
			border +
			'" onclick=\'' +
			executeOnclick +
			"'>EXECUTE</div>" +
