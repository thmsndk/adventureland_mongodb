/**
 * Auto-generated G key unions for Monaco IntelliSense.
 * Source: design/*.js — do not edit by hand.
 * Regenerate: node agentic/generate_monaco_g_keys.js
 */

/** Monster species id (`entity.mtype` / `G.monsters` key). */
type MonsterKey =
	| "a1" // Spike
	| "a2" // Bill
	| "a3" // Lestat
...
type ItemKey =
	...
	| "puppy1" // Egg
	| "puppyer" // Licence to Adopt a Puppy
	| "pvptoken" // PVP Token
	...
	| "xpscroll" // XP Scroll
	| "xptome" // Tome of Protection
	| "xshield" // Shield X
	| "xshot" // X-Shot
	| "zapper" // The Zapper;

/** Map id (`character.map` / `G.maps` key). */
type MapKey =
...
/** Skill id (`G.skills` key), including potion aliases like `use_hp`. */
type SkillKey =
	| "3shot" // 3-Shot
...
/** Character class id (`character.ctype` / `G.classes` key). */
type ClassKey =
	| "mage"
	| "merchant"
	| "paladin"
...
/** Server event id (`G.events` / {@link join}). */
type EventKey =
	| "abtesting" // A/B Testing
	| "crabxx" // Giga Crab
	| "egghunt" // Egg Hunt
...
/** Craft recipe product id (`G.craft` key / {@link auto_craft}). */
type CraftKey =
	| "armorring"
	| "basketofeggs"
	| "bfangamulet"
...
/** Weapon / tool `wtype` (`G.items` + class mainhand/offhand/doublehand keys). */
type WeaponType =
	| "axe"
	| "basher"
	| "bow"
...
/** Cosmetic hair id (`G.cosmetics.hair` / `character.cx.hair`). */
type CosmeticHairKey =
	| "bwhair"
	| "hairdo100"
	| "hairdo101"
	| "hairdo102"
...
/** Cosmetic hat id (`G.cosmetics.hat`). */
type CosmeticHatKey =
	| "hat100";

/** Cosmetic head / skin id (`G.cosmetics.head`). */
type CosmeticHeadKey =
	| "blackhead"
	| "bwhead"
	| "fmakeup02"
	| "fmakeup03"
...
/** Cosmetic bundle id (`G.cosmetics.bundle`). */
type CosmeticBundleKey =
	| "blackw"
	| "pinkb"
	| "rogueb";

/** Cosmetic prop id (`G.cosmetics.prop`). */
type CosmeticPropKey =
	| "bathat"
	| "lchar1b"
	| "lchar1d"
	| "lchar1e"
...
/** Gravestone cosmetic id (`G.cosmetics.gravestone`). */
type CosmeticGravestoneKey =
	| "gravestone"
	| "gravestonea"
	| "xgravestone0"
	| "xgravestone1"
...
/** Equipment slot names on `character.slots`. */
type SlotType =
	| "amulet"
	| "belt"
	| "cape"
...
/** Server region ids. */
type ServerRegion = "EU" | "US" | "ASIA";

/** Common server identifiers. */
type ServerIdentifier = "I" | "II" | "III" | "PVP" | "TEST";
